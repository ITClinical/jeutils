...
import com.eutils.net.*;
import com.eutils.io.*;
...
*@version 1.1
*/
public class EFetch extends Entrez implements InputStreamParser{
	...
	*/
	public EFetch(ESearch search) throws IllegalArgumentException{
		super(search);
		setURL("http://eutils.ncbi.nlm.nih.gov/entrez/eutils/efetch.fcgi");
	...
	*/
	public void parseInput(InputStream is) throws IOException{
		if ( DEBUG ){
			if ( output == null ){
				System.out.println("Processing eFetch...");
			}else{
				output.notice("Processing eFetch...");
			}
		}
